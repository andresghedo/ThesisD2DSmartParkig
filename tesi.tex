...
\\Come citato in [31] molti sistemi si basano su tecniche di \textit{VIP} (Video Image Processing) per dedurre l'occupazione o meno dei parcheggi. 
...
Un altro modo di propagazione distribuita può avvenire invece tramite l'utilizzo di Smartphone, utilizzando il paradigma \textit{D2D} (Device-To-Device)[13].
...
\bibitem{K31} G. Revathi, V.R.Sarma Dhulipala, ''Smart Parking Systems and Sensors: A Survey``, IEEE, 2012.
\bibitem{K32} Felipe Domingos da Cunha, Azzedine Boukerche, Leandro Villas, Aline Carneiro Viana, Antonio A. F. Loureiro, ''Data Communication in VANETs: A Survey, Challenges and Applications``, INRIA, 2014.
\end{thebibliography}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%non numera l'ultima pagina sinistra
\clearpage{\pagestyle{empty}\cleardoublepage}
\end{document}
