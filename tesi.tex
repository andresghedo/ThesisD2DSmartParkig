...
L'implementazione però non è resa possibile a causa del basso contenuto, in termini di dimensione, che il tipo di dato Map\textless String, String \textgreater può contenere.
