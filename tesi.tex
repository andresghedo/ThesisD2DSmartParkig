...
Ogni dispositivo, che presenta il servizio di comunicazione e sincronizzazione attivo, può interpretare fondamentalmente due ruoli:
\begin{itemize}
 ...
 verranno avviati i canali di comunicazione, su cui effettuare una sincronizzazione tra i due device.
\end{itemize}
